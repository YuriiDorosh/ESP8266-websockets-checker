...
def register_wifi_handlers(dp: Dispatcher) -> None:
    ...
    dp.register_message_handler(__wifi_statuses_last_24_hours, commands=["status_last_24_hours"])
    dp.register_message_handler(__wifi_statuses_last_week, commands=["status_last_week"])
